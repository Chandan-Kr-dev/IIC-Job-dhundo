...
const Banner = ({query,handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14' style={{
      background: "linear-gradient(to bottom ,rgba(229,233.156.0.53), rgba(85,66,227,0.73))",
      backgroundSize: "cover"

    }}>
        <h1 className='text-5xl font-bold text-primary mb-3'>Find your <span className='text-blue'>new job</span> today</h1>
        <p className="text-lg text-black/80 mb-8">Thousands of jobs in the computer, engineering and technology sectors are waiting for you.</p>
